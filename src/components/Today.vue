...
<script>
  ...
  export default {
    ...
    methods: {
      getFixtures() {
        fetch(`https://apifootball.com/api/?action=get_events&from=todayDate&to=todayDate&league_id=63&APIkey=51d9ac8fbe11e79e2bcba99d48a61323f5ebf0a30b582607f9318f9d97236b2c`)
          .then(res => res.json())
          .then(data => {
            if (data.error) {
